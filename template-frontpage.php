				...
				if ( get_theme_mod( 'islemag_section1_fullwidth', false) == false ) { ?>
					<div class="islemag-section1">
						...
						if( is_active_sidebar( 'islemag-ads' ) ){ ?>
							<div itemscope itemtype="http://schema.org/WPAdBlock" id="sidebar-ads-area-1" aria-label="<?php esc_html_e('Ads Area 1', 'reviewzine'); ?>">
								<?php dynamic_sidebar( 'islemag-ads' ); ?>
							</div>
          				<?php 
          				}

						$islemag_section_title = get_theme_mod( 'islemag_section1_title', esc_html__( 'Section 1', 'reviewzine' ) );
						...
						<?php
							...
							if( isset( $wp_customize ) ) { ?>
								<h2 class="title-border title-bg-line islemag_only_customizer mb30">
									<span></span>
								</h2>
							<?php
							}
				...
				if ( get_theme_mod( 'islemag_section2_fullwidth', false) == false ) { ?>
					<div class="islemag-section2">
						...
						if( is_active_sidebar( 'ads-2' ) ){ ?>
							<div itemscope itemtype="http://schema.org/WPAdBlock" id="sidebar-ads-area-2" aria-label="<?php esc_html_e('Ads Area 2', 'reviewzine'); ?>">
								<?php dynamic_sidebar( 'ads-2' ); ?>
							</div>
						<?php 
						}

						$islemag_section_title = get_theme_mod( 'islemag_section2_title', esc_html__( 'Section 2', 'reviewzine' ) );
				...
				if ( get_theme_mod( 'islemag_section3_fullwidth', false) == false ) { ?>
					<div class="islemag-section3">
						...
						if( is_active_sidebar( 'ads-3' ) ){ ?>
							<div itemscope itemtype="http://schema.org/WPAdBlock" id="sidebar-ads-area-3" aria-label="<?php esc_html_e('Ads Area 3', 'reviewzine'); ?>">
								<?php dynamic_sidebar( 'ads-3' ); ?>
							</div>
						<?php 
						}

						$islemag_section_title = get_theme_mod( 'islemag_section3_title', esc_html__( 'Section 3', 'reviewzine' ) );
						if( !empty( $islemag_section_title ) ) { ?>
							<h2 class="title-border title-bg-line mb30">
								<span><?php echo esc_attr( $islemag_section_title ); ?></span>
							</h2>
				...
				if ( get_theme_mod( 'islemag_section4_fullwidth', false) == false ) { ?>
					<div class="islemag-section4">
						...
						if( is_active_sidebar( 'ads-4' ) ){ ?>
							<div itemscope itemtype="http://schema.org/WPAdBlock" id="sidebar-ads-area-4" aria-label="<?php esc_html_e('Ads Area 4', 'reviewzine'); ?>">
								<?php dynamic_sidebar( 'ads-4' ); ?>
							</div>
						<?php 
						} 

						$islemag_section_title = get_theme_mod( 'islemag_section4_title', esc_html__( 'Section 4', 'reviewzine' ) );
						if( !empty( $islemag_section_title ) ) { ?>
							<h2 class="title-border title-bg-line mb30">
								<span><?php echo esc_attr( $islemag_section_title ); ?></span>
							</h2>
				...
				if ( get_theme_mod( 'islemag_section5_fullwidth', false) == false ) { ?>
					<div class="islemag-section5">
						...
						if( is_active_sidebar( 'ads-5' ) ){ ?>
							<div itemscope itemtype="http://schema.org/WPAdBlock" id="sidebar-ads-area-5" aria-label="<?php esc_html_e('Ads Area 5', 'reviewzine'); ?>">
								<?php dynamic_sidebar( 'ads-5' ); ?>
							</div>
						<?php 
						}

						$islemag_section_title = get_theme_mod( 'islemag_section5_title', esc_html__( 'Section 5', 'reviewzine' ) );
						if( !empty( $islemag_section_title ) ) { ?>
							<h2 class="title-border title-bg-line mb30">
								<span><?php echo esc_attr( $islemag_section_title ); ?></span>
							</h2>
					...
					if ( get_theme_mod( 'islemag_section1_fullwidth', false) == true ) { ?>
						<div class="islemag-section1">
							...
							<?php
								...
								global $wp_customize;
								if( isset( $wp_customize ) ) { ?>
									<h2 class="title-border title-bg-line islemag_only_customizer mb30"><span></span></h2>
								<?php
								}
							}
							$islemag_section_category = esc_attr( get_theme_mod( 'islemag_section1_category', 'all' ) );
